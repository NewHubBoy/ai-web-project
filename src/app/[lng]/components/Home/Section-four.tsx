        ...
        <div className="flex items-center justify-center w-full">
          <div className="basis-1/2">
            <div className="p-[40px]">
              <h2 className="text-[50px] font-semibold mb-7 text-[#2b2b2b]">什么是AI音乐</h2>
              <p className="text-[17px] leading-7 font-normal text-[#2b2b2b] mb-8">
              ...
              <button className="py-3 px-6 bg-[#fcaf3b] text-[17px] font-semibold leading-7">进入知识库</button>
            </div>
          </div>
          <div className="basis-1/2">
